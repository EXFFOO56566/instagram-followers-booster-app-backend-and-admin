...
const UserDetail = ({location, history, ...props}) => {
  ...
  React.useEffect(() => {
    (async () => {
      if (router?.params?.id) {
        const {data: users} = await POST(`/admin/detailUser`, {
            ...
            <div className="ml-4">
              <div className="pa-16 font-bold uppercase">
                ...
                <Can I="guess" a="functions">
                  @{encodeString(userDetail?.username)}
                </Can>
              </div>
              <div
                className="uppercase"
              ...
              >
                ...
                <Can I="guess" a="functions">
                  users/@{encodeString(userDetail?.username)}
                </Can>
              </div>
            </div>
          </div>
            ...
            <div className="px-4 w-full flex justify-center">
              <div className="justify-center flex items-center flex-col">
                <img
                  ...
                  src={process.env.PROXY_API + ':3003/' + userDetail?.pk + '.png'}
            ...
            <div className="px-4 mt-5 flex justify-between">
              <div className="flex flex-col flex-1 items-center justify-center">
                <div className="pa-title pa-18">
                  {kFormatter(userDetail?.followings || 0)}
                </div>
                <div
              ...
              <div className="flex flex-col flex-1 items-center justify-center">
                <div className="pa-title pa-18">
                  {kFormatter(userDetail?.followers || 0)}
                </div>
                <div
                  className="text-gray-500 uppercase"
                  style={{fontSize: 8, letterSpacing: 1.25}}
